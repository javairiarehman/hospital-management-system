...
<a href="edit_doc.php" style="color: ; text-decoration:none"><strong>Back</strong></a>
</label>
<?php ;
...
<p>Go <a href="new_doc.php">back</a> to the form</p>
<?php }
else { ?>

<form action="new_doc.php" method="GET">
