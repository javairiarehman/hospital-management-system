...
<a href="login1.php" style="color: ; text-decoration:none"><strong>Back</strong></a>
</label>
<?php ;
...
$conn->query("Update into patient values('$patient_id','$doctor_id','$patient_name','$patient_phn','$patient_email','$patient_gender','$patient_address','$patient_age','$patient_diagnosis','$patient_cnic','$patient_password')");
