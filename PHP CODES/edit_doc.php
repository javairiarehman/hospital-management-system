...
padding: 14px 28px;
  ...
  cursor: pointer;
		...
		<br>
		<br>
		     <td width="40px"style="font-size40px;text-align:center"><a href="new_doc.php" style="color:white ; text-decoration:none"><strong>New Doctor</strong></a></td>
		     <td width="40px"style="font-size40px;text-align:center"><a href="op_del_doc.php" style="color:white ; text-decoration:none"><strong>Remove Doctor</strong></a></td>
